...
class FixedDynamicQuizApp(App):
    def build(self):
       ...
       # Bouton Paramètres dans le coin supérieur droit
        ...
        self.btn_menu_persistant = Button(text="Revenir au Menu Principal", font_size='20sp', bold=True, size_hint_y=None, height=dp(80), background_color=(0.75, 0.2, 0.2, 1))
        ...
        self.btn_retour_isole = Button(text="← Retour Évolution", size_hint=(1, None), height=dp(80), font_size='22sp', bold=True, background_color=(0.75, 0.2, 0.2, 1))
...
# 5. le guide d'utilisation de l'appli
        ...
        btn_fermer = Button(
            ...
            size_hint=(0.8, None),
            height=dp(50),
            pos_hint={'center_x': 0.5, 'top': 0.63 - (5 * (h_btn + espacement)) / Window.height},
            background_color=(0, 0, 0, 0)
        )
...
# ___INDICATEUR DE SAISIE ___
    ...
    def afficher_menu_principal_modes(self):         
        ...
        btn_entrainement = Button(text=" Entraînement ", font_size='22sp', text_size=(1 * Window.width - dp(20), None), halign='center',        valign='middle', bold=True, background_color=(0, 0, 0, 0), size_hint=(1,None), height=dp(80))
        ...
        btn_examen = Button(text="Examen Blanc ", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_stats = Button(text=" Salle des Rangs\n & Statistiques", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_avis_general = Button(text="Laisser un avis au Développeur", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0, 0, 0, 0), size_hint=(1, None), height=dp(80))
        ...
        btn_ia = Button(text='Lancer l\'IA (En ligne)', font_size='22sp', height =dp(80), bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint =(1, None), background_color=(0, 0, 0, 0))
        ...
        btn_autres = Button(text='Autres bientot disponible', font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle',  size_hint=(1, None), height=dp(80), background_color=(0, 0, 0, 0))
  ...
  # ____SOUS-MENUS NIVEAUX D'ACTIVITÉS____
    def afficher_sous_menu_niveaux_activites(self, instance):
        ...
        for activite in liste_16_activites:
            ...
            if est_debloque:
                btn = Button(text=f"✔ {activite}", font_size='14sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
                ...
                btn = Button(text=f"🔒 {activite}\n[Requis: {nom_rang_nom}]", font_size='12sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_retour = Button(text="← Revenir à l'Accueil", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
    ...
    def lancer_activite_niveau(self, nom_activite):
        ...
        btn_retour = Button(text="← Retour aux niveaux", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
 ...
 #___SOUS-MENUS DES SUJETS CASSE-TÊTE ___ 
    def afficher_sous_menu_sujets_casse_tete(self, instance):
        ...
        btn_paradoxes = Button(text="Paradoxes Mathématiques", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_enigmes = Button(text="Énigmes Algébriques", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle',background_color =(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_geometrie = Button(text="Défis Géométriques Poussés", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None), halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
    ...
    def lancer_sujet_casse_tete(self, type_defi):
        ...
        btn_retour = Button(text="← Retour aux sujets", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
    ...
    def afficher_sous_menu_joueurs(self, instance):
        ...
        btn_2p = Button(text="2 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0,0,0,0), size_hint_y=None, height=dp(80))
        ...
        btn_3p = Button(text="3 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
        ...
        btn_4p = Button(text="4 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(80))
    ...
    def lancer_mode_multijoueur(self, nombre_joueurs):
        ...
        btn_retour = Button(text="← Retour au menu", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.75, 0.2, 0.2, 1), size_hint_y=None, height=dp(90))
...
# --- SOUS-MENUS DU PANNEAU D'ÉVOLUTION --
    def afficher_sous_menu_evolution(self, instance):
        ...
        btn_profil_rangs = Button(text=" Mon Grade, XP & Rythme Actuel", font_size='22sp', bold=True, background_color=(0.114, 0.459, 0.737, 1), text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint_y=None, height=dp(90))
        btn_profil_rangs.bind(on_press=self.afficher_tableau_de_bord_stats)

        btn_liste_grades = Button(text=" Liste Officielle des Rangs", font_size='22sp', bold=True, background_color=(0.3, 0.2, 0.6, 1), text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint_y=None, height=dp(90))
        btn_liste_grades.bind(on_press=self.afficher_liste_complete_des_rangs)

        btn_modules_maitrise = Button(text=" Maîtrise des Chapitres", font_size='22sp', bold=True, background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', height=dp(80))
    ...
    def afficher_menu_niveaux(self):
        ...
        for nv in niveaux.keys():
            btn = Button(text=nv, font_size='22sp', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
...
# ___SOUS-MENUS DE CHOIX DES CLASSES ___
    def afficher_menu_classes(self, niveau, list_cl):
        ...
        for cl in list_cl:
            btn = Button(text=cl, font_size='22sp', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', height=dp(80))
    ...
    def afficher_tableau_de_bord_stats(self, instance):
        ...
        btn_regles_rang = Button(text="ℹ Comment fonctionne le système de Rang ?", size_hint=(1, None), height=dp(50), background_color=(0.3, 0.2, 0.6, 1), font_size='18sp')
    ...
    def creer_interface_suivante(self):
        ...
        btn_suivant = Button(text="Continuer →", font_size='22sp', bold=True, size_hint=(1,None), height=dp(80), background_color=(0.2, 0.7, 0.4, 1))
