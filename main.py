...
class FixedDynamicQuizApp(App):
    ...
    def demander_nom_utilisateur(self, instance):
        self.interaction_layout.clear_widgets()
        self.info_label.text = "Profil Utilisateur"
        self.question_label.text = "Entrez votre nom ou pseudonyme :"

        self.input_nom = TextInput(
            text=self.nom_utilisateur if hasattr(self, 'nom_utilisateur') else "",
            hint_text="Votre nom...",
            multiline=False,
            size_hint_y=None,
            height=dp(50),
        ...
        btn_valider.bind(on_press=self.enregistrer_nom_utilisateur)
        with btn_valider.canvas.before:
            Color(0, 0, 0, 0.3)
            btn_valider.ombre = RoundedRectangle(pos=(btn_valider.x + dp(17), btn_valider.y - dp(17)), size=btn_valider.size, radius=[dp(27)])
            Color(0.2, 0.7, 0.4, 1)
            btn_valider.fond = RoundedRectangle(pos=btn_valider.pos, size=btn_valider.size, radius=[dp(27)])
            btn_valider.bind(pos=lambda inst, val: setattr(inst.fond, 'pos', val) or setattr(inst.ombre, 'pos', (val[0] + dp(3), val[1] - dp(3))))
            btn_valider.bind(size=lambda inst, val: setattr(inst.fond, 'size', val) or setattr(inst.ombre, 'size', val))
        ...
        self.interaction_layout.add_widget(btn_valider)
        self.interaction_layout.add_widget(btn_retour)

    def enregistrer_nom_utilisateur(self, instance):
        nom_saisi = self.input_nom.text.strip()
        if nom_saisi:
            self.nom_utilisateur = nom_saisi
            self.sauvegarder_donnees_locales()
            self.question_label.text = f"Nom enregistré avec succès !\nBienvenue, {self.nom_utilisateur}."
        else:
            self.question_label.text = "Veuillez entrer un nom valide."
...
# ___INDICATEUR DE SAISIE ___
    ...
    def mettre_a_jour_suggestions_niveau(self, instance, valeur):
        ...
        for item in self.liste_niveaux_valides:
            if saisie in item.lower():
                btn = Button(text=f"Dire : {item}", size_hint_x=None, width=dp(150), background_color=(0.3, 0.2, 0.6, 1))
  ...
  # ___SAUVEGARDE LOCALE NOUVELLE INFO ___
    ...
    def demander_nom_utilisateur(self):
        ...
        self.input_nom = TextInput(hint_text="Ton prénom ici...", multiline=False, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle',size_hint_y=None, height=dp(50), font_size='22sp')
        btn_valider_nom = Button(text="S'enregistrer et Continuer", size_hint_y=None, text_size=(1* Window.width - dp(20), None), halign='center', valign='middle',height=dp(130), background_color=(0.2, 0.7, 0.4, 1), font_size='22sp', bold=True)
    ...
    def afficher_menu_principal_modes(self):  
        ...
        btn_avis_general = Button(text="Laisser un avis au Développeur", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0, 0, 0, 0), size_hint=(1, None), height=dp(50))
        ...
        btn_ia = Button(text='Lancer l\'IA (En ligne)', font_size='22sp', height =dp(50), bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint =(1, None), background_color=(0, 0, 0, 0))
        ...
        btn=Button(text='bientôt disponible', font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0, 0, 0, 0))
        with btn.canvas.before:
            Color(0, 0, 0, 0.3)
        ...
        btn_autres = Button(text='Autres bientot disponible', font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle',  size_hint=(1, None), height=dp(50), background_color=(0, 0, 0, 0))
 ...
 #___SOUS-MENUS DES SUJETS CASSE-TÊTE ___
    ...
    def lancer_mode_multijoueur(self, nombre_joueurs):
        ...
        btn_retour = Button(text="← Retour au menu", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0, 0, 0, 0), size_hint_y=None, height=dp(90))
...
# --- SOUS-MENUS DU PANNEAU D'ÉVOLUTION --
    def afficher_sous_menu_evolution(self, instance):
        ...
        btn_profil_rangs = Button(text=" Mon Grade, XP & Rythme Actuel", font_size='22sp', bold=True, background_color=(0, 0, 0, 0), text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint_y=None, height=dp(90))
        ...
        btn_liste_grades = Button(text=" Liste Officielle des Rangs", font_size='22sp', bold=True, background_color=(0, 0, 0, 0), text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint_y=None, height=dp(90))
...
#==== MENU LATÉRAL DE L'ASSISTANT IA ====
    def ouvrir_panneau_menu_ia(self, instance):
        ...
        btn_requete_libre = Button(
            ...
            background_color=(0.831, 0.682, 0.216, 1)
        )
    ...
    def verifier_reponse_interactive(self, choix_utilisateur):
        ...
        if mode_actuel == "Entraînement":
            ...
            if est_correct:
                ...
                btn_suite = Button(text="Question Suivante", font_size='18sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.2, 0.7, 0.4, 1), size_hint_y=None, height=dp(45))
                ...
                btn_suite = Button(text="Continuer l'entraînement", font_size='18sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.2, 0.7, 0.4, 1), size_hint_y=None, height=dp(45))
                btn_suite.bind(on_press=lambda x: self.requeter_ia_generer("Entraînement"))
