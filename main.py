...
# ___INDICATEUR DE SAISIE ___
  ...
  # ___SAUVEGARDE LOCALE NOUVELLE INFO ___
    ...
    def afficher_menu_principal_modes(self):  
        ...
        layout_l2 = BoxLayout(orientation='horizontal', size_hint=(1, None), height=dp(50), spacing=dp(15))
        ...
        layout_l3 = BoxLayout(orientation='horizontal', size_hint=(1, None), height=dp(50), spacing=dp(15))
        ...
        layout_l4 = BoxLayout(orientation='horizontal', size_hint=(1, None), height=dp(50), spacing=dp(15))
