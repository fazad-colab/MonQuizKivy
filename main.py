...
# ___INDICATEUR DE SAISIE ___
    ...
    def afficher_menu_principal_modes(self):         
        ...
        btn_entrainement = Button(text=" Entraînement ", font_size='22sp', text_size=(1 * Window.width - dp(20), None), halign='center',        valign='middle', bold=True, background_color=(0.114, 0.459, 0.737, 1), size_hint=(1,None), height=dp(80))
        btn_entrainement.bind(on_press=lambda x: self.selectionner_mode("Entraînement"))
        layout_l1.add_widget(btn_entrainement)
        
        btn_examen = Button(text="Examen Blanc ", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        ...
        btn_jouer_4 = Button(text="Joue jusqu'à 4", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1))
        btn_jouer_4.bind(on_press=self.afficher_sous_menu_joueurs)
        layout_l2.add_widget(btn_jouer_4)

        
        btn_stats = Button(text=" Salle des Rangs\n & Statistiques", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        ...
        btn_avis_general = Button(text="Laisser un avis au Développeur", font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0.831, 0.682, 0.216, 1), size_hint=(1, None), height=dp(80))
        ...
        btn_niveaux_activites = Button(text="Niveaux d'Activités", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1))
        btn_niveaux_activites.bind(on_press=self.afficher_sous_menu_niveaux_activites)
        layout_l3.add_widget(btn_niveaux_activites)
   
        btn_sujets = Button(text="Sujets Casse-Tête", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1))
        ...
        btn_ia = Button(text='Lancer l\'IA (En ligne)', font_size='22sp', height =dp(80), bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', size_hint =(1, None), background_color=(0.114, 0.459, 0.737, 1))
        layout_l4.add_widget(btn_ia)
        btn_ia.bind(on_press=self.afficher_menu_ia_parametres)
        
        layout_l4.add_widget(Button(text='bientôt disponible', font_size='22sp', text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', bold=True, background_color=(0.114, 0.459, 0.737, 1)))
        self.interaction_layout.add_widget(layout_l4)
        
        btn_autres = Button(text='Autres bientot disponible', font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle',  size_hint=(1, None), height=dp(80), background_color=(0.114, 0.459, 0.737, 1))
    ...
    def afficher_sous_menu_niveaux_activites(self, instance):
        ...
        for activite in liste_16_activites:
            ...
            if est_debloque:
                ...
                btn = Button(text=f"🔒 {activite}\n[Requis: {nom_rang_nom}]", font_size='12sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
    ...
    def lancer_activite_niveau(self, nom_activite):
        ...
        btn_retour = Button(text="← Retour aux niveaux", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.75, 0.2, 0.2, 1), size_hint_y=None, height=dp(80))
 ...
 #___SOUS-MENUS DES SUJETS CASSE-TÊTE ___ 
    def afficher_sous_menu_sujets_casse_tete(self, instance):
        ...
        btn_paradoxes = Button(text="Paradoxes Mathématiques", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        btn_paradoxes.bind(on_press=lambda x: self.lancer_sujet_casse_tete("Paradoxes"))

        btn_enigmes = Button(text="Énigmes Algébriques", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        btn_enigmes.bind(on_press=lambda x: self.lancer_sujet_casse_tete("Énigmes"))

        btn_geometrie = Button(text="Défis Géométriques Poussés", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None), halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
    ...
    def lancer_sujet_casse_tete(self, type_defi):
        ...
        btn_retour = Button(text="← Retour aux sujets", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.75, 0.2, 0.2, 1), size_hint_y=None, height=dp(80))
    ...
    def afficher_sous_menu_joueurs(self, instance):
        ...
        btn_2p = Button(text="2 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        btn_2p.bind(on_press=lambda x: self.lancer_mode_multijoueur(2))

        btn_3p = Button(text="3 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
        btn_3p.bind(on_press=lambda x: self.lancer_mode_multijoueur(3))

        btn_4p = Button(text="4 Joueurs", font_size='22sp', bold=True, text_size=(1 * Window.width - dp(20), None),halign='center', valign='middle', background_color=(0.114, 0.459, 0.737, 1), size_hint_y=None, height=dp(80))
